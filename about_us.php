  ...
  <head>
    ...
    <div class="container">
        <div class="judul text-center mt-5">
          <img src="images/background/background_3.jpg">
        <div class="vc_empty_space"   style="height: 30px"><span class="vc_empty_space_inner"></span></div>
	    <div  class="wpb_single_image wpb_content_element vc_align_left">
        <h2 style="font-size: 44px;color: #000000;line-height: 44px;text-align: center" class="vc_custom_heading" >MEET OUR TEAM</h2>
        <h5 style="font-size: 20px;color: #242d00;line-height: 24px;text-align: center" class="vc_custom_heading" >THE RIGHT PEOPLE IN THE RIGHT PLACE AND IN THE RIGHT TIME</h5>
        <div class="vc_empty_space"   style="height: 40px"><span class="vc_empty_space_inner"></span></div></div></div></div></div>
          <div class="vc_row wpb_row vc_row-fluid">
            <div class="wpb_column vc_column_container vc_col-sm-2"><div class="vc_column-inner vc_custom_1485270531028">
   ...
   <img src="images/Square-Voal.jpg"><br><br>
