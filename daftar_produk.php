            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="edit_produk.php?id_produk=<?php echo $result['id_produk']  ?>" 
                class="btn btn-success btn-sm btn-block">EDIT</a>
                <a href="hapus_produk.php?id_produk=<?php echo $result['id_produk']  ?>" 
                class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endforeach; ?>
